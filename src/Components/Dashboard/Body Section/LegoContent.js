...
const LegoContent = () => {
  ...
  const { srno, title, uploadDate, newprice, truncatedPrice, discountPercentage, discountPrice, ShippingCharge, ebayAveragePrice, eBayTopPrice, eBaySales, ManufacturerPrice, Seller, contentimage } = location.state.legoItem;
    ...
    <div>
      ...
      <table className="table-container">
        <tbody>
          ...
          <tr>
            <td className="table-cell table-cell-bold">Upload Date:</td>
            <td className="table-cell">{formatDate(uploadDate)}</td>
          </tr>
          <tr>
